...
ALLOWED_HOSTS = ['*']  # Temporarily allow all for deployment debugging
...
# SSL and Proxy configuration for Render
...
# Specifically allow headers and methods needed for preflight
CORS_ALLOW_METHODS = [
